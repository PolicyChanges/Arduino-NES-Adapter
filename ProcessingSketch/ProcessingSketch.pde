...
void serialRead() {
  ...
  while (arduino.available() > 0) {
    ...
    case 'U':
      VKey.keyPress(KeyEvent.VK_UP); break;
    case '2':
      VKey.keyRelease(KeyEvent.VK_UP);  break;
    case 'D': 
      VKey.keyPress(KeyEvent.VK_DOWN);  break;
    case '3':
      VKey.keyRelease(KeyEvent.VK_DOWN); break;
    case 'L': 
      VKey.keyPress(KeyEvent.VK_LEFT); break; 
    case '4':
      VKey.keyRelease(KeyEvent.VK_LEFT);break;
    case 'R': 
      VKey.keyPress(KeyEvent.VK_RIGHT);break;
    case '5':
      VKey.keyRelease(KeyEvent.VK_RIGHT); break;
    case 'E':
      VKey.keyPress(KeyEvent.VK_ESCAPE); break; 
    case '7':
      VKey.keyRelease(KeyEvent.VK_ESCAPE); break;
    case 'S': 
      VKey.keyPress(KeyEvent.VK_ENTER); break;
    case '6':
      VKey.keyRelease(KeyEvent.VK_ENTER); break;
    case 'B':
      VKey.keyPress(KeyEvent.VK_Z); break; 
    case '1':
      VKey.keyRelease(KeyEvent.VK_Z); break;  
    case 'A':
      VKey.keyPress(KeyEvent.VK_X); break;
    case '0':
      VKey.keyRelease(KeyEvent.VK_X); break;
     default:
     /*
     if(swapped)
     {
